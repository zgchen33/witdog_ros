...
#### 1.1.1. Run the base driver:
    ...
    roslaunch witdog_config bringup.launch rviz:=true
...
#### 1.2.2. Run gmapping package and move_base:
    ...
    roslaunch witdog_config slam.launch rviz:=true
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch witdog_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch witdog_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
